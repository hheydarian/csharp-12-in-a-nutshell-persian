...
پایانگرها متدهایی هستند که تنها در کلاس‌ها وجود دارند و پیش از آن که گردآورنده‌ی  زباله (garbage collector) حافظه را برای یک شیء بی پژوه(unreferenced) بازپس گیرد،
اجرا میشود.
